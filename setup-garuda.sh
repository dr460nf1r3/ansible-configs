...
sudo pacman -S --needed linux-tkg-cfs-generic_v3 linux-tkg-cfs-generic_v3-headers octopi-git xf86-video-amdgpu mesa-tkg-git lib32-mesa-tkg-git
...
cp -r ./.config/autostart ~/.config/ && cp -r ./.local/share/applications ~/.local/share/
