...
# CachyOS repo
wget https://mirror.cachyos.org/repo/x86_64/cachyos/cachyos-v3-mirrorlist-6-1-any.pkg.tar.zst
sudo pacman -U cachyos-v3-mirrorlist-6-1-any.pkg.tar.zst
...
sudo pacman -S --needed linux-tkg-cfs linux-tkg-cfs-headers octopi-git xf86-video-amdgpu mesa-tkg-git lib32-mesa-tkg-git
